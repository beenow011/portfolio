...
function Education() {
  return (
    <div className="flex flex-col p-3 gap-5 font-tektur">
      <div>
        <h1 className="text-2xl">10th std, Kuvempu Vidyanikethana School</h1>
        <p className="text-sm">Chickmagaluru, Karnataka</p>
        <p className="font-semibold">PERCENTAGE : 96.32%</p>
        <p className="text-sm">June 2018 - April 2019</p>
      </div>
      <div>
        <h1 className="text-2xl">PUC Science, Sri Sai Angels Pu College</h1>
        <p className="text-sm">Chickmagaluru, Karnataka</p>
      ...
      <div>
        ...
        <p className="text-sm">Mysuru, Karnataka</p>
